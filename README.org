...
If you use [[https://github.com/org-roam/org-roam][GitHub - org-roam/org-roam: Rudimentary Roam replica with Org-mode]] or
[[https://github.com/Kungsgeten/org-brain][GitHub - Kungsgeten/org-brain: Org-mode wiki + concept-mapping]] this package is
rather useless to you.

It adds a completion-company-backend based on
bookmark-list. bookmark-plus allows use to add a new bookmark-type:
org-id-links.

If you delete a header you have to manually delete the bookmark else
...
This package is not complete and can certaintly be improved. This is
...
12. Switches to org-buffer and point jumps to the picked header
